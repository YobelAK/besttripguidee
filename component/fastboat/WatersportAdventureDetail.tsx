    ...
    <div data-id={dataId} className={className} style={{ width: '100%', backgroundColor: 'white' }}>
      ...
      <main style={{ padding: 12, maxWidth: 820, margin: '0 auto' }}>
        ...
        <section style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 16 }}>
          <div>
            <p style={{ fontSize: 15, color: '#6b7280', textDecoration: 'line-through', marginBottom: 2 }}>IDR 250,000</p>
            <p style={{ fontSize: 20, fontWeight: 700, color: '#000000', marginBottom: 8 }}>IDR 150,000</p>
            <div style={{ display: 'inline-block', backgroundColor: '#d1fae5', padding: '0px 10px', borderRadius: 8 }}>
              <p style={{ fontSize: 15 , color: '#2dbe8d', fontWeight: 500 }}>Save 40% when booking online</p>
            </div>
          </div>
          <button
            onClick={onAddToTrip}
