      ...
      <Stack gap="xl">
        ...
        <Stack gap="md">
          <Group justify="space-between" align="center">
            <Text style={{ color: '#6b7280' }}>Participant (2x)</Text>
            <Text style={{ fontWeight: 500, color: '#111827' }}>IDR 300,000</Text>
          </Group>
          <Group justify="space-between" align="center">
            <Text style={{ color: '#6b7280' }}>Equipment Fee (2x)</Text>
          ...
          <Stack gap="xs">
            ...
            <Group justify="space-between" align="center">
              <Text size="sm" style={{ color: '#6b7280' }}>Photo Package</Text>
              <Text size="sm" style={{ fontWeight: 500, color: '#111827' }}>IDR 200,000</Text>
            </Group>
            <Group justify="space-between" align="center">
              <Text size="sm" style={{ color: '#6b7280' }}>Transport Service</Text>
              <Text size="sm" style={{ fontWeight: 500, color: '#111827' }}>IDR 120,000</Text>
            </Group>
            <Group justify="space-between" align="center">
              <Text size="sm" style={{ color: '#6b7280' }}>Meal Package</Text>
          ...
          <Group justify="space-between" align="center">
            ...
            <Text size="lg" style={{ fontWeight: 700, color: '#284361' }}>IDR 740,000</Text>
          </Group>
        </Stack>
        <Stack gap="md">
          <Alert 
