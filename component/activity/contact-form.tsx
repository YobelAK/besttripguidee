  ...
  return (
    <Paper shadow="sm" p="xl" radius="lg" bg="white" style={{ position: 'relative' }}>
      <Stack gap="xl">
        ...
        <Title order={2} size="xl" style={{ fontWeight: 600, color: '#111827' }}>Contact Information</Title>
        <Grid gutter="xl">
          <Modal
            opened={modalOpened}
            onClose={closeModal}
        ...
        <Checkbox
          label={
            <Text size="sm" c="dimmed">
              I agree to the{' '}
              <Anchor onClick={(e) => { e.preventDefault(); setModalType('terms'); setModalOpened(true); }} c="#284361">
                Terms and Conditions
              </Anchor>{' '}
              and{' '}
              <Anchor onClick={(e) => { e.preventDefault(); setModalType('privacy'); setModalOpened(true); }} c="#284361">
                Privacy Policy
              </Anchor>
            </Text>
          }
