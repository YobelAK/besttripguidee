...
import { IconCalendar, IconClock, IconTicket, IconMapPin } from '@tabler/icons-react';
  ...
  return (
    <Paper shadow="sm" radius="lg" p="xl" bg="white">
      <Stack gap="xl">
        ...
        <Stack gap="md">
          <Text size="sm" fw={600} c="dark">Activity Details</Text>
          <Stack gap="md">
            <Group align="flex-start" gap="md">
              <IconMapPin size={20} color="#6b7280" style={{ marginTop: 2 }} />
              <Stack gap="xs">
                <Text fw={500} c="dark">Location: Ubud, Bali</Text>
                <Text size="sm" c="dimmed">Activity: ATV Adventure</Text>
                <Text size="sm" c="dimmed">Participants: 2</Text>
              </Stack>
            </Group>
            ...
            <Group align="center" gap="md">
              ...
              <Text c="dark">Session: 10:00 AM – 11:30 AM</Text>
            </Group>
          </Stack>
        </Stack>
        ...
        <Stack gap="md">
          <Text size="sm" fw={600} c="dark">Participant Details</Text>
          <Table>
            <Table.Thead>
              <Table.Tr style={{ backgroundColor: '#f9fafb' }}>
                <Table.Th style={{ padding: '8px 16px', color: '#6b7280', fontWeight: 500 }}>No.</Table.Th>
