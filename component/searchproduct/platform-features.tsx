...
export function PlatformFeatures() {
  return (
    <Box style={{ backgroundColor: '#f8f9fa', padding: '8px 0',paddingTop: '50px' }}>
      <Container size="xl">
        <Stack align="center" gap="xl" mb="xl">
          ...
          >
            Your Premier Booking Platform for Sea Adventures
          </Title>
          <Text 
            size="15px"
            ta="center" 
          ...
          >
            Experience the best of Indonesia's islands with Best Trip Guide - reliable, safe, and unforgettable.
          </Text>
        </Stack>
