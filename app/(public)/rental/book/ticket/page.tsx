...
import { AdditionalPackages, PackageItem } from '@/components/rental/additional-packages';
    ...
    <Box style={{ minHeight: '100vh', backgroundColor: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box component="main" style={{ flex: 1 }}>
        <Container size="xl" py="xl">
                ...
                <Card withBorder radius="md" p="xl" bg="white">
                  ...
                  <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
                    ...
                    <Box>
                      ...
                      <Text fw={600} c="#284361">4 Passengers</Text>
                    </Box>
                  <Box>
                  ...
                  <Box>
                    <Text size="sm" c="dimmed" mb={4}>Vehicle Type</Text>
                    <Text fw={600} c="#284361">
                      SUV / 7-Seater
                    </Text>
                  </Box>
                  <Box>
                    <Text size="sm" c="dimmed" mb={4}>Pickup Location</Text>
                    <Text fw={600} c="#284361">
                      Denpasar, Bali
                    </Text>
                  </Box>
                  <Box>
                    <Text size="sm" c="dimmed" mb={4}>Driver Included</Text>
                    <Text fw={600} c="#284361">
                      Yes
                    </Text>
                  </Box>
                  <Box>
                    ...
                    <Box>
                      <Text size="sm" c="dimmed" mb={4}>Rental Duration</Text>
                      <Text fw={600} c="#284361">
                        Full Day
                      </Text>
                    </Box>
              ...
              <Stack gap="xl">
                <Card withBorder radius="md" p="xl" bg="white">
                  ...
                  <Text size="sm" c="dimmed" ta="center">
                    Show this QR at the Caspia Rentals desk for verification.
                  </Text>
                </Card>
                <Card withBorder radius="md" p="xl" bg="white">
              ...
              <Table>
                <Table.Thead>
                  <Table.Tr>
                    ...
                    <Table.Th>
                      <Text size="sm" fw={500} c="dimmed">Passenger Type</Text>
                    </Table.Th>
                  </Table.Tr>
                </Table.Thead>
                <Table.Tbody>
          ...
          <AdditionalPackages packages={additionalPackages} footerNote="Your add-on activities will be coordinated automatically upon arrival at Nusa Penida." />
          <Card withBorder radius="md" p="xl" mb="xl" bg="white">
            <Title order={2} size="xl" fw={600} c="#284361" mb="xl">
              Meeting Information
            </Title>
            <Stack gap="xl">
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Text c="dark" mb={8}>
                    Denpasar City Center
                  </Text>
                  <Text size="sm" c="dimmed">
                    Meet near the main drop-off area
                  </Text>
              ...
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Stack gap={4}>
                    <Text c="dark">• Valid driving license</Text>
                    <Text c="dark">• Security deposit if applicable</Text>
                  </Stack>
                </Box>
              </Group>
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Text c="dark">
                    +62 812 3456 7890 (Caspia Rentals Office)
                  </Text>
                </Box>
              </Group>
            </Stack>
