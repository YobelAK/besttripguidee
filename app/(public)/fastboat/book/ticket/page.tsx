...
import { AdditionalPackages } from '@/component/fastboat/additional-packages';
      ...
      <Box component="main" style={{ flex: 1 }}>
        ...
        <Container size="xl" py="xl">
          ...
          <AdditionalPackages
            ...
            data-id="fastboat-additional-packages"
          />
