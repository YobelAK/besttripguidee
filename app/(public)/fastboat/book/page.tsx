          ...
          <Grid.Col span={{ base: 12, lg: 4 }}>
              ...
              onContinue={async () => {
                ...
                if (res.status === 401) {
                  ...
                  window.location.href = '/login?redirectTo=/fastboat/book/addons';
                  return;
                }
                if (res.ok) {
                  ...
                  if (id) {
                    ...
                    qs.set('id', String(id));
                    if (session) {
                      window.location.href = `/fastboat/book/addons?${qs.toString()}`;
                    } else {
                      window.location.href = `/login?redirectTo=/fastboat/book/addons?${qs.toString()}`;
                    }
                  } else {
                    setContinueLoading(false);
                  }
