...
import { BookingReview } from '@/components/activity/booking-review';
import { PaymentSummary } from '@/components/activity/payment-summary';
import { PaymentMethodSelector } from '@/components/activity/payment-method-selector';
...
export default function PaymentPage() {
  ...
  const handlePayment = () => {
    router.push('/activity/book/ticket');
  };
