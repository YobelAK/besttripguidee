...
import { AdditionalPackages, PackageItem } from '@/components/activity/additional-packages';
import { 
  IconCheck, 
  IconDownload, 
  IconHome,
              ...
              <Stack gap="xl">
                <Card withBorder radius="md" p="xl" bg="white">
                  ...
                  <Text size="sm" c="dimmed" ta="center">
                    Show this QR at the Caspia Activities desk for verification.
                  </Text>
                </Card>
                <Card withBorder radius="md" p="xl" bg="white">
                    ...
                    <Group align="flex-start" gap="md">
                      ...
                      <Box style={{ flex: 1 }}>
                        ...
                        <Text size="sm" c="dimmed">
                          Arrive 15 minutes before session time.
                        </Text>
                      </Box>
                    </Group>
                    <Group align="flex-start" gap="md">
            ...
            <Stack gap="xl">
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Text c="dark" mb={8}>
                    Ubud Activity Center
                  </Text>
                  <Text size="sm" c="dimmed">
                    Check-in counter near Caspia Activities Desk
                  </Text>
              ...
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Text c="dark">
                    09:45 AM (15 minutes before session)
                  </Text>
                </Box>
              </Group>
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Stack gap={4}>
                    <Text c="dark">• Comfortable clothing</Text>
                    <Text c="dark">• Water bottle</Text>
                  </Stack>
                </Box>
              </Group>
              <Group align="flex-start" gap="md">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Text c="dark">
                    +62 812 3456 7890 (Caspia Activities Center)
                  </Text>
                </Box>
              </Group>
            </Stack>
